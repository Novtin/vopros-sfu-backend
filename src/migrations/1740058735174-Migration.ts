...
export class Migration1740058735174 implements MigrationInterface {
  name = 'Migration1740058735174';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "question" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(`ALTER TABLE "question" DROP COLUMN "deletedAt"`);
    await queryRunner.query(
      `ALTER TABLE "question" ADD "deletedAt" TIMESTAMP WITH TIME ZONE`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "answer" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(`ALTER TABLE "answer" DROP COLUMN "updatedAt"`);
    await queryRunner.query(
      `ALTER TABLE "answer" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`,
    );
    await queryRunner.query(`ALTER TABLE "answer" DROP COLUMN "deletedAt"`);
    await queryRunner.query(
      `ALTER TABLE "answer" ADD "deletedAt" TIMESTAMP WITH TIME ZONE`,
    );
  }
